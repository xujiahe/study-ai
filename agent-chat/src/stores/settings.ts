...
export const useSettingsStore = defineStore("settings", () => {
  ...
  const modelOptions = [
    { provider: "zhipu",     models: ["glm-5", "glm-5.1", "glm-4.5", "glm-4.5-air", "glm-4.5-flash"] },
    { provider: "anthropic", models: ["claude-opus-4-5", "claude-3-5-haiku-20241022"] },
    { provider: "openai",    models: ["gpt-4o", "gpt-4o-mini"] },
    { provider: "ollama",    models: ["llama3.2", "qwen2.5-coder", "deepseek-r1"] },
  ];
  ...
  async function saveMcp(server: McpServer) {
