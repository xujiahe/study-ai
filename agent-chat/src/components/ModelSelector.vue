...
.trigger { display: flex; align-items: center; gap: 6px; background: var(--bg3); border: 1px solid var(--border); border-radius: 8px; padding: 5px 10px; color: var(--text); font-size: 12px; cursor: pointer; white-space: nowrap; }
...
.dropdown { position: absolute; top: calc(100% + 6px); left: 0; background: var(--bg2); border: 1px solid var(--border); border-radius: 10px; padding: 8px; min-width: 200px; z-index: 100; box-shadow: 0 8px 24px rgba(0,0,0,.4); display: flex; flex-direction: column; gap: 4px; }
.group-label { font-size: 11px; color: var(--text-dim); padding: 4px 6px 2px; text-transform: uppercase; letter-spacing: .05em; }
.model-btn { display: block; width: 100%; text-align: left; background: none; border: none; color: var(--text); font-size: 13px; padding: 6px 10px; border-radius: 6px; cursor: pointer; }
